...
class ShopcartList(Resource):
    ...
    @shopcart_ns.marshal_list_with(multi_cart_response, code=200, description="Success")
...
@shopcart_ns.param("user_id", "The user ID")
@shopcart_ns.param("item_id", "The item ID")
class ShopcartItemDelete(Resource):
